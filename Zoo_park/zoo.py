...
class Animal:
    ...
    def __str__(self):
        return f"\nwith animals : name= {self.name} ,speces= {self.species},age= {self.age},height= {self.height},width= {self.width},preffered habitat= {self.preferred_habitat},health= {self.health}"        
